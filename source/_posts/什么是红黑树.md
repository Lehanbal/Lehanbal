...
![二叉搜索树](https://gitee.com/lehanbal/blog-image/raw/master/img/二叉搜索树.png)
...
![jio掰树](https://gitee.com/lehanbal/blog-image/raw/master/img/jio掰树.png)
...
![红黑树](https://gitee.com/lehanbal/blog-image/raw/master/img/红黑树.png)
...
左旋：![左旋转](https://gitee.com/lehanbal/blog-image/raw/master/img/左旋转.png)

右旋：![右旋转](https://gitee.com/lehanbal/blog-image/raw/master/img/右旋转.png)
...
![叔叔节点为红色](https://gitee.com/lehanbal/blog-image/raw/master/img/叔叔节点为红色.png)
...
![左左情况](https://gitee.com/lehanbal/blog-image/raw/master/img/左左情况.png)

**3.2.2情况：左右关系：**

![左右情况](https://gitee.com/lehanbal/blog-image/raw/master/img/左右情况.png)

**3.2.3右右情况**

![右右情况](https://gitee.com/lehanbal/blog-image/raw/master/img/右右情况.png)

**3.2.4右左情况**

![右左情况](https://gitee.com/lehanbal/blog-image/raw/master/img/右左情况.png)
...
![删除结点情况2](https://gitee.com/lehanbal/blog-image/raw/master/img/删除结点情况2.png)

情况1解决方案：这是最为复杂的情况了。

1. 待删除的结点是红色，删就完事了，不会影响到红黑树平衡。
   ![删除结点是红色](https://gitee.com/lehanbal/blog-image/raw/master/img/删除结点是红色.png)

2. 待删除的结点是黑色，它兄弟是黑色。

   2.1.它兄弟没有孩子，并且它们的爹是红色

   ![删除情况2.1](https://gitee.com/lehanbal/blog-image/raw/master/img/删除情况2.1.png)

   2.2.它兄弟没有孩子，并且它们的爹是黑色

   ![删除情况2.2](https://gitee.com/lehanbal/blog-image/raw/master/img/删除情况2.2.png)
   ...
   ![删除结点情况2.3](https://gitee.com/lehanbal/blog-image/raw/master/img/删除结点情况2.3.png)

   2.4.它兄弟只有一个红色右孩子

   ​		和2.3的情况十分相似，都是子债父偿，但是2.3情况下当家作主的是侄子结点，在2.4情况下它兄弟当家做主了。

   ![删除结点情况2.4](https://gitee.com/lehanbal/blog-image/raw/master/img/删除结点情况2.4.png)

3. 待删除的结点是黑色，兄弟结点是红色（该情况下红色肯定是带着两个红色孩子，不然树不会平衡）
   ![删除结点情况3](https://gitee.com/lehanbal/blog-image/raw/master/img/删除结点情况3.png)
